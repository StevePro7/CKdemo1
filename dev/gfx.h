extern const unsigned char	clear__palette__bin[];
#define				clear__palette__bin_size 1

extern const unsigned char	clear__tilemap__stmcompr[];
#define				clear__tilemap__stmcompr_size 25
