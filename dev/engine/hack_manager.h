...
void engine_hack_manager_init()
{
	...
	// TODO update these comments better........................!!
	hacker_steps = PEEK(HACKER_START + 0);		// 0x0050		// 0=steps on otherwise off.
	hacker_delay = PEEK(HACKER_START + 1);		// 0x0051		// 0=delay on otherwise off.
	hacker_hands = PEEK(HACKER_START + 2);		// 0x0052		// 0=hands on otherwise off.
